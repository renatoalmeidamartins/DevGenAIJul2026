...
## Please don't forget to fill the survey, through [Myclass -> past classes](https://myclass.skillbuilder.aws/), or in the email you received confirming course completion. Through myclass, you can also get the class certiicate
...
- [Course information - we ran on version 2.1.9, which failed in the last command](https://releases.awstc.com/?course=Developing+Generative+AI+Applications+on+AWS). When a new version shows up, I will update the class, and update the reference here.
## Day 1 links
