...
- ~~[Course information - we ran on version 2.1.9, which failed in the last command](https://releases.awstc.com/?course=Developing+Generative+AI+Applications+on+AWS)~~. **Updated labs to 2.1.10, fixing the issue we had in class**
## Day 1 links
